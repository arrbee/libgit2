...
static const struct clay_func _all_callbacks[] = {
	...
	{"3", &test_core_filebuf__3, 1},
	{"4", &test_core_filebuf__4, 1},
	{"5", &test_core_filebuf__5, 1},
	...
	{"find_invalid_chars_in_oid", &test_object_raw_chars__find_invalid_chars_in_oid, 9},
	{"build_valid_oid_from_raw_bytes", &test_object_raw_chars__build_valid_oid_from_raw_bytes, 9},
	{"succeed_on_copy_oid", &test_object_raw_compare__succeed_on_copy_oid, 10},
	{"succeed_on_oid_comparison_lesser", &test_object_raw_compare__succeed_on_oid_comparison_lesser, 10},
	{"succeed_on_oid_comparison_equal", &test_object_raw_compare__succeed_on_oid_comparison_equal, 10},
	{"succeed_on_oid_comparison_greater", &test_object_raw_compare__succeed_on_oid_comparison_greater, 10},
	{"compare_fmt_oids", &test_object_raw_compare__compare_fmt_oids, 10},
	{"compare_allocfmt_oids", &test_object_raw_compare__compare_allocfmt_oids, 10},
	{"compare_pathfmt_oids", &test_object_raw_compare__compare_pathfmt_oids, 10},
	{"succeed_on_oid_to_string_conversion", &test_object_raw_convert__succeed_on_oid_to_string_conversion, 11},
	{"succeed_on_oid_to_string_conversion_big", &test_object_raw_convert__succeed_on_oid_to_string_conversion_big, 11},
	{"fail_on_invalid_oid_string", &test_object_raw_fromstr__fail_on_invalid_oid_string, 12},
	{"succeed_on_valid_oid_string", &test_object_raw_fromstr__succeed_on_valid_oid_string, 12},
	{"hash_by_blocks", &test_object_raw_hash__hash_by_blocks, 13},
	{"hash_buffer_in_single_call", &test_object_raw_hash__hash_buffer_in_single_call, 13},
	{"hash_vector", &test_object_raw_hash__hash_vector, 13},
	{"hash_junk_data", &test_object_raw_hash__hash_junk_data, 13},
	{"hash_commit_object", &test_object_raw_hash__hash_commit_object, 13},
	{"hash_tree_object", &test_object_raw_hash__hash_tree_object, 13},
	{"hash_tag_object", &test_object_raw_hash__hash_tag_object, 13},
	{"hash_zero_length_object", &test_object_raw_hash__hash_zero_length_object, 13},
	{"hash_one_byte_object", &test_object_raw_hash__hash_one_byte_object, 13},
	{"hash_two_byte_object", &test_object_raw_hash__hash_two_byte_object, 13},
	{"hash_multi_byte_object", &test_object_raw_hash__hash_multi_byte_object, 13},
	{"oid_shortener_no_duplicates", &test_object_raw_short__oid_shortener_no_duplicates, 14},
	{"oid_shortener_stresstest_git_oid_shorten", &test_object_raw_short__oid_shortener_stresstest_git_oid_shorten, 14},
	{"validate_oid_size", &test_object_raw_size__validate_oid_size, 15},
	{"convert_type_to_string", &test_object_raw_type2string__convert_type_to_string, 16},
	{"convert_string_to_type", &test_object_raw_type2string__convert_string_to_type, 16},
	{"check_type_is_loose", &test_object_raw_type2string__check_type_is_loose, 16},
	{"retrieve_tree_from_path_to_treeentry", &test_object_tree_frompath__retrieve_tree_from_path_to_treeentry, 17},
	{"fail_when_processing_an_unknown_tree_segment", &test_object_tree_frompath__fail_when_processing_an_unknown_tree_segment, 17},
	{"fail_when_processing_an_invalid_path", &test_object_tree_frompath__fail_when_processing_an_invalid_path, 17},
	{"hash_single_file", &test_status_single__hash_single_file, 18},
	{"whole_repository", &test_status_worktree__whole_repository, 19},
	{"empty_repository", &test_status_worktree__empty_repository, 19}
};
...
static const char _suites_str[] = "core::dirent, core::filebuf, core::oid, core::path, core::rmdir, core::string, core::strtol, core::vector, network::remotes, object::raw::chars, object::raw::compare, object::raw::convert, object::raw::fromstr, object::raw::hash, object::raw::short, object::raw::size, object::raw::type2string, object::tree::frompath, status::single, status::worktree";
